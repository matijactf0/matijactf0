...
![Trophy](https://github-profile-trophy.vercel.app/?username=matijactf0&theme=radical&no-frame=true&no-bg=true&margin-w=4&column=8)
...
| **service** | **description** | **technologies** | **experience** |
|-------------|-----------------|------------------|----------------|
| 🌐 **web development** | full-stack applications with modern ui/ux | react, next.js, typescript, tailwind | 3+ years |
| 🎮 **game server hosting** | professional hosting solutions & control panels | fivem, minecraft, pterodactyl, linux | 2+ years |
| 🤖 **discord bot development** | advanced bots with custom functionality | discord.js, node.js, mongodb, apis | 2+ years |
| 🔧 **api development** | restful apis and microservices architecture | node.js, express, mongodb, postgresql | 2+ years |
| 🗄️ **database design** | optimized database structures and queries | mysql, mongodb, postgresql, redis | 2+ years |
| ☁️ **cloud deployment** | scalable hosting and ci/cd pipelines | vercel, digitalocean, docker, git | 1+ years |
...
const matija = {
  ...
  building: [
    ...
    "📊 analytics dashboard for game servers",
...
[![fivem-scripts](https://github-readme-stats.vercel.app/api/pin/?username=matijactf0&repo=fivem-scripts&theme=radical&hide_border=true&bg_color=0D1117&title_color=FF6B35&icon_color=FF6B35&text_color=FFFFFF)](https://github.com/matijactf0/fivem-scripts)
...
[![Portfolio](https://img.shields.io/badge/portfolio-matkez.dev-FF6B35?style=for-the-badge&logo=firefox&logoColor=white)](https://matkez.dev)

<img src="https://media.giphy.com/media/LnQjpWaON8nhr21vNW/giphy.gif" width="60" alt="waving hand"/> 

### 💬 i'm always excited to discuss:

- 🚀 **new project opportunities** - freelance work, collaborations, partnerships
- 💡 **innovative ideas** - turning concepts into reality with modern technology
